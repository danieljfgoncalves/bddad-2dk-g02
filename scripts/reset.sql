...
CREATE TABLE RESERVA (
	...
	CLASSE INTEGER NOT NULL, -- TEM DE EXISTIR NO TIPO DE AVIAO DO VOO
	NUM_FILA_LUGAR INTEGER NOT NULL, -- TEM DE EXISTIR NO TIPO DE AVIAO DO VOO
	LETRA_LUGAR CHAR(1) NOT NULL, -- TEM DE EXISTIR NO TIPO DE AVIAO DO VOO
