...
CREATE TABLE PRECO(
	VIAGEM_PLANEADA_ID INTEGER REFERENCES VIAGEM_PLANEADA(VIAGEM_PLANEADA_ID),
	CLASSE_ID INTEGER REFERENCES CLASSE(CLASSE_ID),
	PRECO FLOAT(10) NOT NULL,
	CONSTRAINT PK_PRECO PRIMARY KEY (VIAGEM_PLANEADA_ID, CLASSE_ID)
);
...
CREATE TABLE RESERVA (
	...
	VIAGEM_PLANEADA INTEGER,
	CLASSE INTEGER,
	NUM_FILA_LUGAR INTEGER,
	LETRA_LUGAR CHAR(1),
  CONSTRAINT FK_RESERVA FOREIGN KEY (VIAGEM_PLANEADA, CLASSE) REFERENCES PRECO(VIAGEM_PLANEADA_ID, CLASSE_ID)
);
