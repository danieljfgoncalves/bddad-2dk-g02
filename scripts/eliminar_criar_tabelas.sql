...
CREATE TABLE AVIAO (
	...
	MARCA INTEGER,
	MODELO INTEGER,
  CONSTRAINT FK_AVIAO FOREIGN KEY (MARCA, MODELO) REFERENCES TIPO_AVIAO(MARCA, MODELO)
);
...
CREATE TABLE CLASSE_TIPO_AVIAO (
  ...
  CONSTRAINT FK_CLASSE FOREIGN KEY (MARCA, MODELO) REFERENCES TIPO_AVIAO(MARCA, MODELO)
);
...
CREATE TABLE LUGAR (
	...
	MODELO INTEGER,
	CLASSE INTEGER,
  CONSTRAINT FK_LUGAR FOREIGN KEY (MARCA, MODELO, CLASSE) REFERENCES CLASSE_TIPO_AVIAO(MARCA, MODELO, CLASSE),
...
CREATE TABLE HORAS_VOO (
  ...
  CONSTRAINT FK_HORAS_VOO FOREIGN KEY (MARCA, MODELO) REFERENCES TIPO_AVIAO(MARCA, MODELO)
);
